...
public class LoginActivity extends AppCompatActivity {
    ...
    public void createDummyData(AppDatabase db){
        ...
        Provimi provimiTwoJanar = new Provimi("Mikroprocesore dhe Mikrokontrollere",1,janarDate);
        Provimi provimiThreeJanar = new Provimi("Programimi I",1,janarDate);
        Provimi provimiFourJanar = new Provimi("Bazat e Elektroteknikes",1,janarDate);
        Provimi provimiFiveJanar = new Provimi("Sinjale dhe Sisteme",1,janarDate);
        Provimi provimiSixJanar = new Provimi("Matematike I",1,janarDate);
        ...
        Provimi provimiTwoPrill = new Provimi("Mikroprocesore dhe Mikrokontrollere",2,aprilDate);
        Provimi provimiThreePrill = new Provimi("Programimi I",2,aprilDate);
        Provimi provimiFourPrill = new Provimi("Bazat e Elektroteknikes",2,aprilDate);
        Provimi provimiFivePrill = new Provimi("Sinjale dhe Sisteme",2,aprilDate);
        Provimi provimiSixPrill = new Provimi("Matematike I",2,aprilDate);
        ...
        Provimi provimiTwoQershor = new Provimi("Mikroprocesore dhe Mikrokontrollere",3,juneDate);
        Provimi provimiThreeQershor = new Provimi("Programimi I",3,juneDate);
        Provimi provimiFourQershor = new Provimi("Bazat e Elektroteknikes",3,juneDate);
        Provimi provimiFiveQershor = new Provimi("Sinjale dhe Sisteme",3,juneDate);
        Provimi provimiSixQershor = new Provimi("Matematike I",3,juneDate);
        ...
        Provimi provimiFourShtator = new Provimi("Bazat e Elektroteknikes",4,septemberDate);
        Provimi provimiFiveShtator = new Provimi("Sinjale dhe Sisteme",4,septemberDate);
        Provimi provimiSixShtator = new Provimi("Matematike I",4,septemberDate);
        ...
        Provimi provimiFourNentor = new Provimi("Bazat e Elektroteknikes",5,novemberDate);
        Provimi provimiFiveNentor = new Provimi("Sinjale dhe Sisteme",5,novemberDate);
        Provimi provimiSixNentor = new Provimi("Matematike I",5,novemberDate);
