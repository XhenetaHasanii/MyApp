...
public class SeptemberAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        LinearLayout ll_bg3;
        ll_bg3= view.findViewById(R.id.ll_bg4);
        int number1 = getRandom(3);
        if (number1 == 1) {
            ll_bg3.setBackground(ContextCompat.getDrawable(list, R.drawable.gradient_1));
        }
        if (number1 == 2) {
            ll_bg3.setBackground(ContextCompat.getDrawable(list, R.drawable.gradient_2));
        }
        if (number1 == 3) {
            ll_bg3.setBackground(ContextCompat.getDrawable(list, R.drawable.gradient_3));
        }
